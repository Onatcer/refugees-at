<template>
  ...
  <div class="relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto  px-4 sm:px-6 lg:px-8 pb-14 ">

      <div class="text-2xl md:text-3xl font-bold pt-6 pb-6 md:pb-12"><span class="text-gray-500">Kategorie: </span>{{ getNameForCategory(route.params.name) }} </div>
